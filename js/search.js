...
function loadSearchProduct(){
    ...
    for(var i=0;i<products.length;i++){
        HTML+="<div class='card'><img class='img-card' src='"+products[i].image+"'/> <div class='card-body'><div class='card-reviews'><i class='ti-star'></i><i class='ti-star' n></i><i class='ti-star'></i><i class='ti-star'></i><i class='ti-star'></i><p class='status-review'>review</p></div><div class='card-infor'><span class='infor-name' >"+products[i].name+" "+"</span><span class='infor-price'>"+products[i].price+"</span></div></div></div>";
        // console.log(HTML);
    }
    HTML+="</div>"
    console.log(HTML);
