...
function checkLogin() {
  ...
  if (user !== "" && password !== "") {
    ...
    if (localStorage.getItem("user") === null) {
      ...
      let message =
        "<span class='warning-alert' style='margin-left:40%;margin-bottom:20px' > <strong>Your user or password incorrect</strong> </span>";
...
function messageAlert(messageAlert) {
  let message =
    "<span class='warning-alert' style='margin-left:145px' > <strong>" +
    messageAlert +
    "</strong> </span>";
  return message;
}
