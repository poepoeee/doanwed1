      ...
      listCart.map((x)=>{
        ...
        <div class="product">
              <ul class="title-cart">
                ...
                <li class="total">£${(x.price.split('£'))[1]*x.soluong}<i onclick="deleteProductFromCart(this)" class="ti-close hover_icon"></i></li>
...
function changeCount(object){
    ...
    localStorage.setItem('carts',JSON.stringify(listCart));
    object.parentElement.nextElementSibling.innerHTML='£'+(numberPrice*object.value)+`<i class="ti-close hover_icon"></i>`;
}
